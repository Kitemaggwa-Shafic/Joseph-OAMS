...
<div id="templatemo_wrapper">
  <div id="templatemo_header">
   ...
   <div class="main-content-agile" style="margin-left:-110px; width:330px;">
            ...
            <form method="post" enctype="multipart/form-data" action="checklogin_student.php">     	       
					<input placeholder="E-mail Address" name="emailaddress" type="email" required="">
	...
	<!-- end of templatemo_sidebar -->
        ...
        <div id="templatemo_content" style="margin-top:-450px;">
            ...
            <p><img src='images/mru.jpg'  width="1000" height="500"/></p>
