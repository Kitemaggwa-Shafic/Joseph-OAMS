...
<div id="templatemo_wrapper">
  <div id="templatemo_header">
    ...
    <div id="templatemo_main">
        ...
        <div id="templatemo_content" style="margin-top:-350px;">
        
            <h2 align="center" style="color:#ee0000">New Student</h2><br/>
			<form  method="post"  enctype="multipart/form-data" name="frm" action="addstudent.php" style="margin-left:-170px;">
...
move_uploaded_file($_FILES["image"]["tmp_name"], "uploads/" . $_FILES["image"]["name"]);
 ...
 $insert="insert into student values(NULL,'$no','$fname','$lname','$gd','$dob','$tel','$ms','$age','$nation','$location')";


                
                $sql=mysql_query($insert,$con); //this function excecutes our query
				header("Location:uceresults.php");
